...
def SYN3():
    ...
    # Location of data
    base_dir = "C:/Users/stjst/Desktop/Work/Image_Processing/20180124/Aligned Tiff" #Location of align tif"
    resolution = {'res_xy_nm': 100, 'res_z_nm': 70} #Resolution of a pixel
    thresh = 0.9 #What qualifies for final probability map
    number_of_datasets = 19 #Number of wells

    #Rb Antibody
    conjugate_fn_str = 'synapsin1' #String segment to search in a filename 
    ...
    reference_fn_str = 'synapsin1' #String segment to search in a filename
    target_fn_str = 'K28'
