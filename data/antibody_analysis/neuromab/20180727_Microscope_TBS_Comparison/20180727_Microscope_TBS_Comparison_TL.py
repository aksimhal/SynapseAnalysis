...
def COMP():
    ...
    # Location of data
    base_dir = "C:/Users/i3x-MM/Desktop/SACT/20180727_NM_Scope/TL/align" #Location of align tif"
...
def main():
    ...
    sheet_name = '20180727_Microscope_TBS_TL'
    fn = '20180727_Microscope_TBS_TL.xlsx'
    df_list = [COMP_df]
